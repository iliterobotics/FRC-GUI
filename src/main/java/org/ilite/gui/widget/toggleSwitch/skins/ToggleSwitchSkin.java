package org.ilite.gui.widget.toggleSwitch.skins;
...
import org.ilite.gui.widget.toggleSwitch.ToggleSwitch;
...
public class ToggleSwitchSkin extends SkinBase<ToggleSwitch>{
	...
	public ToggleSwitchSkin(ToggleSwitch control){
		...
		control.getStylesheets().add("/org/ilite/widgets/ToggleSwitch.css");
